...
for policy in "$temporary/policy.sh" "$temporary/preinst.policy" \
	...
	[ "$ADGUARDHOME_UPGRADE_SOURCES" = \
		'2.4.0-r1 2.4.0-r2 2.4.0-r3 2.4.0-r4 2.4.0-r5 2.4.0-r6' ]
	for release in 1 2 3 4 5 6; do
		upgrade_source_allowed "2.4.0-r$release"
		printf 'source_version=2.4.0-r%s\nwas_running=1\n' "$release" \
			>"$temporary/state"
		upgrade_state_source_allowed "$temporary/state"
	done
	for rejected in '' unknown 2.3.0-r6 2.4.0 2.4.0-r0 2.4.0-r7 \
		2.4.0-r8 2.4.0-r99 2.4.0-r01 2.4.0-r6-extra 2.4.1-r1 2.5.0-r1 \
...
printf 'ok - single-source r1-r6 upgrade policy, hook expansion and rejection gates\n'

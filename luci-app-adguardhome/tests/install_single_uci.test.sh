...
require_text "$makefile" '2.4.0-r1|2.4.0-r2|2.4.0-r3|2.4.0-r4|2.4.0-r5)'
require_text "$makefile" 'Only luci-app-adguardhome 2.4.0-r1, r2, r3, r4 or r5 can be upgraded in place.'
reject_text "$makefile" '/usr/lib/opkg/'
require_text "$makefile" "printf 'source_version=%s\\n'"
require_text "$makefile" "grep -Eq '^source_version=2[.]4[.]0-r[12345]\$\$'"
...
require_text "$defaults" "grep -Eq '^source_version=2[.]4[.]0-r[12345]\$'"

...
for policy in "$temporary/policy.sh" "$temporary/preinst.policy" \
	...
	[ "$ADGUARDHOME_UPGRADE_SOURCES" = \
		'2.4.0-r1 2.4.0-r2 2.4.0-r3 2.4.0-r4 2.4.0-r5 2.4.0-r6 2.4.0-r7 2.4.0-r8 2.4.0-r9 2.4.0-r10 2.5.0-r1 2.6.0-r1 2.6.0-r2' ]
	...
	for rejected in '' unknown 2.3.0-r6 2.4.0 2.4.0-r0 \
		2.4.0-r11 2.4.0-r99 2.4.0-r01 2.4.0-r8-extra 2.4.1-r1 2.5.0 2.5.0-r2 2.6.0 2.6.0-r3 \
...
printf 'ok - single-source 2.4/2.5/2.6-r1/r2 upgrade policy, hook expansion and rejection gates\n'

...
for policy in "$temporary/policy.sh" "$temporary/preinst.policy" \
	...
	[ "$ADGUARDHOME_UPGRADE_SOURCES" = \
		'2.4.0-r1 2.4.0-r2 2.4.0-r3 2.4.0-r4 2.4.0-r5 2.4.0-r6 2.4.0-r7 2.4.0-r8 2.4.0-r9' ]
	for release in 1 2 3 4 5 6 7 8 9; do
...
printf 'ok - single-source r1-r9 upgrade policy, hook expansion and rejection gates\n'

...
fetch adguardhome.apk c0f6cc7135a7e69470111fe7507431d3632cd087f0732011556601301d4b7bcc \
...
# Preserve target permissions even when the caller is unprivileged.
tar -xpzf "$runtime/rootfs.tar.gz" -C "$runtime/root" \
...
tar --warning=no-unknown-keyword -xpzf "$runtime/apk-tools-static.apk" -C "$runtime/apk" sbin/apk.static
